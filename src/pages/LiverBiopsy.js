...
class LiverBiopsy extends Component {
    render() {
      return (
        <>
            <h4>Liver Biopsy</h4>
            ...
            <p>Before scheduling your biopsy, the
            ...
            <p>You must not eat or drink anything for 8
            ...
            whether to take your normal medications	during the fasting period and may give you other special instructions.</p>

            <h5>Procedure</h5>

            <p>Liver biopsy is considered minor surgery and is done at the hospital. The nurse will start
            ...
            <p>You will need to hold very still so that the physician does not nick the lung or gallbladder,
            ...
            procedure takes about 20 minutes.</p>

            <p>Two other methods of liver biopsy are also available. For a laparoscopic biopsy, the
            ...
            <p>After the biopsy, the physician will put a bandage over the incision and have you lie on
            ...
            complications before sending you home.</p>
            ...
            <p>Like any surgery, liver biopsy does have some risks, such as puncture of the lung or
            gallbladder, infection, bleeding, and pain, but these complications are rare.</p>
        </>
      );
    }
  }
   
  export default LiverBiopsy;