    ...
    render() {
      return (
        ...
        <h4>ERCP</h4>
          ...
          <p>ERCP is used primarily to diagnose and
          ...
          <p>For the procedure, you will lie on your
          ...
          rays. X rays are taken as soon as the dye is injected.</p>

          <p>If the exam shows a gallstone or narrowing of the ducts, the physician can insert
          instruments into the scope to remove or relieve the obstruction. Also, tissue samples
          (biopsy) can be taken for further testing.</p>

          <p>Possible complications of ERCP include pancreatitis (inflammation of the pancreas),
          ...
          injected, but that should go away in a few days.</p>

          <p>ERCP takes 30 minutes to 2 hours. You may have some discomfort when the physician
          ...
          may need to stay in the hospital overnight.</p>

          <h5>Preparation</h5>

          <p>Your stomach and duodenum must be empty for the procedure to be accurate and safe.
          ...
          to drive because of the sedatives. The physician may give you other special instructions.</p>
        </>
      );
    }
  }
